...
<html lang="en">
    ...
    <body>
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <img src="assets/images/sdo_logo.png" width="25%" alt="SDO Logo">
                            <h1 class="display-5 fw-bolder text-white mb-2"><a href="?home" class="text-decoration-none text-white">DocuTrack</a></h1>
        ...
        <footer class="py-5 bg-dark">
            <div class="container px-5"><p class="m-0 text-center text-white">Copyright &copy; <script>document.write(new Date().getFullYear())</script><br>
